...
const quoteFormSchema = z.object({
  ...
  address: z.string().trim().min(5, "Please enter a complete address").max(200, "Address must be less than 200 characters"),
...
const QuoteForm = () => {
  ...
  const validateField = (name: string, value: string) => {
    try {
      const fieldSchema = quoteFormSchema.shape[name as keyof typeof quoteFormSchema.shape];
      if (fieldSchema) {
